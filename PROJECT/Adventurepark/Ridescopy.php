...
$sel = "select * from tbl_rides where ride_id=" . $_SESSION["rid"];
...
if (isset($_POST["btn_update"])) {
    ...
    $update = "UPDATE tbl_rides
                SET ride_description = '$description', ride_photo = '$photo', ride_rate = '$rate' ,ride_age='$age'
                WHERE ride_id = " . $_SESSION["uid"];
    
    if ($conn->query($update)) {
        echo "<script>
                alert('Profile updated successfully!');
                window.location='Ridescopy.php';
              </script>";
    }
}
?>
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="txt_des" id="txt_des" value="<?php echo $data['ride_description']; ?>" rows="5" required></textarea>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <button type="submit" name="btn_update" class="btn btn-primary">Edit</button>
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="Rides.php?editid=<?php echo $row["ride_id"]; ?>" class="btn btn-danger btn-sm">Edit</a> -->
