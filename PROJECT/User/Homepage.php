...
<body>
Welcome <?php echo $data["user_name"]; ?><br>
<a href="Myprofile.php">My profile</a>&nbsp;
<a href="BookRides.php">Book </a>
</body>
</html> -->
...
<link rel="stylesheet" href="../Assets/Templates/Main/index2.css" media="screen">
    ...
    <meta name="theme-color" content="#48ac9">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Myprofile.php" style="padding: 10px 20px;">My profile</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="BookRides.php" style="padding: 10px 20px;">Book Rides</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Mybookings.php" style="padding: 10px 20px;">My Bookings</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="View Rides.php" style="padding: 10px 20px;">Rides</a>
    ...
    ?>
          <div class="u-align-center u-border-1 u-border-palette-2-base u-container-align-center u-container-style u-list-item u-repeater-item u-shape-rectangle u-white u-list-item-1">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
              <img class="u-expanded-width" src="../Assets/Files/Images/<?php echo $row["ride_photo"]; ?>" alt="" data-image-width="900" data-image-height="600">
              <h4 class="u-hover-feature u-text u-text-4"><?php echo $row["category_name"]; ?></h4>
              <p class="u-hover-feature u-text u-text-3"><?php echo $row["ride_description"]; ?></p>
              <a href="RideDetails.php?rid=<?php echo $row["ride_id"]; ?>" class="u-border-1 u-border-active-black u-border-hover-black u-border-no-left u-border-no-right u-border-no-top u-border-palette-2-base u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-button-style u-hover-feature u-none u-radius-0 u-text-active-palette-2-base u-text-hover-palette-2-base u-text-palette-2-base u-top-left-radius-0 u-top-right-radius-0 u-btn-1">more</a> 
